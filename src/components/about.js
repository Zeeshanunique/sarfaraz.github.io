        ...
        <div className="w-4/5 md:w-3/5">
			...
			<div className="w-full flex flex-col md:flex-row pt-12">
				...
				<div className="w-full mt-5 md:mt-0 md:w-1/2 font-roboto flex justify-center flex-col">
					<p>Hey! My name is Sarfaraz and I'm currently pursuing my B.tech degree at Presidency University, a Data science Enthusiast and a Programmer. I love writing code, problem solving and learning new stuff related to computer science. My main language of working is python but I get along just fine with the other ones as well.</p>
					<br></br>
